...
import { HeroParallaxDemo } from '../app/example/HeroParallaxDemo';
// import { TextRevealCardPreview } from '../app/example/TextRevealCardPreview';
import { WavyBackgroundDemo } from '../app/example/WavyBackgroundDemo';
// import { SpotlightPreview } from '../app/example/SpotlightDemo';
import { FloatingNavDemo } from '../app/example/FloatingNavbar';
import { Navbar } from '../app/example/Navbar';
import { TracingBeam } from "@/components/ui/tracing-beam";
import { ExperienceCard } from './example/experience-card';
import experiences from "../lib/experience.json";
import { Separator } from "@/components/ui/separator";
import { SVGMaskEffectDemo } from '../app/example/Svg-effect-header';
import { MultiStepLoaderDemo } from '../app/example/Loader';
import { MacbookScrollDemo } from '../app/example/MacBook';
import { BackgroundBeamsDemo } from './example/beam';
import { BackgroundBoxesDemo } from './example/bgbox';

import projects from "../lib/projects.json";
import { Reveal } from './example/reveal';
import { ProjectCard3d } from './example/project-card-3d';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export default function Home() {
  // State for detecting touch devices
  const [isTouchDevice, setIsTouchDevice] = useState(false);

  // Effect to check for touch devices on component mount
  useEffect(() => {
                            ...
                            <div className="flex flex-row flex-wrap justify-center gap-4">
                                ...
                                width="100"
                                 ...
                                 className="hover:animate-spin">
                                  ...
                                  <path d="M91.101 164.861c7.285 12.718 20.98 21.296 36.69 21.296 15.807 0 29.58-8.687 36.828-21.541l-36.437-21.107-37.081 21.352" fill="#1A4674"/><path d="M255.569 84.72c-.002-4.83-1.035-9.098-3.124-12.761l-124.263 71.55 124.413 72.074c1.994-3.608 2.985-7.793 2.987-12.518 0 0 0-78.889-.013-118.345" fill="#1B598E"/>
                                  <path d="M248.728 148.661h-9.722v9.724h-9.724v-9.724h-9.721v-9.721h9.721v-9.722h9.724v9.722h9.722v9.721M213.253 148.661h-9.721v9.724h-9.722v-9.724h-9.722v-9.721h9.722v-9.722h9.722v9.722h9.721v9.721" fill="#FFF"/><path d="M164.619 164.616c-7.248 12.854-21.021 21.541-36.828 21.541-15.71 0-29.405-8.578-36.69-21.296a42.062 42.062 0 0 1-5.574-20.968c0-23.341 18.923-42.263 42.264-42.263 15.609 0 29.232 8.471 36.553 21.059l36.941-21.272c-14.683-25.346-42.096-42.398-73.494-42.398-46.876 0-84.875 38-84.875 84.874 0 15.378 4.091 29.799 11.241 42.238 14.646 25.48 42.137 42.637 73.634 42.637 31.555 0 59.089-17.226 73.714-42.781l-36.886-21.371" fill="#FFF"/></svg>
                                    <p className="text-sm text-muted-foreground">
                                        C++
                                    </p>
                                </div>
...
<g><path style={{opacity:1, fill:"#6cb33e"}} d="M 197.5,77.5 C 200.425,77.4598 203.091,78.2932 205.5,80C 242.5,101.5 279.5,123 316.5,144.5C 317.833,157.167 317.833,169.833 316.5,182.5C 277.626,205.102 238.626,227.436 199.5,249.5C 160.374,227.436 121.374,205.102 82.5,182.5C 81.1787,169.604 81.1787,156.771 82.5,144C 120.896,121.807 159.229,99.6398 197.5,77.5 Z"/></g>
<g>
  <path style={{opacity:1, fill:"#dcedd2"}} d="M 316.5,200.5 C 316.56,199.957 316.893,199.624 317.5,199.5C 318.817,205.988 318.817,212.322 317.5,218.5C 317.823,212.31 317.49,206.31 316.5,200.5 Z"/>
</g>
<g>
  <path style={{opacity:1, fill:"#6eb440"}} d="M 316.5,200.5 C 317.49,206.31 317.823,212.31 317.5,218.5C 278.194,241.155 238.861,263.822 199.5,286.5C 160.252,263.96 121.085,241.293 82,218.5C 81.3333,212.5 81.3333,206.5 82,200.5C 120.797,223.482 159.964,245.815 199.5,267.5C 238.751,245.577 277.751,223.243 316.5,200.5 Z"/>
</g>
<g>
  <path style={{opacity:1, fill:"#d8ebcc"}} d="M 316.5,237.5 C 316.56,236.957 316.893,236.624 317.5,236.5C 318.817,242.654 318.817,248.654 317.5,254.5C 317.822,248.642 317.489,242.975 316.5,237.5 Z"/>
</g>
<g>
  <path style={{opacity: 1, fill: "#c4e1b3"}} d="M 82.5,237.5 C 81.5111,242.975 81.1778,248.642 81.5,254.5C 80.1834,248.654 80.1834,242.654 81.5,236.5C 82.1067,236.624 82.44,236.957 82.5,237.5 Z"/>
</g>
<g>
  <path style={{opacity:1, fill:"#6eb440"}} d="M 82.5,237.5 C 121.31,260.074 160.31,282.408 199.5,304.5C 238.364,281.902 277.364,259.569 316.5,237.5C 317.489,242.975 317.822,248.642 317.5,254.5C 278.519,277.661 239.185,300.328 199.5,322.5C 159.815,300.328 120.481,277.661 81.5,254.5C 81.1778,248.642 81.5111,242.975 82.5,237.5 Z"/>
</g>
</svg>
                                    <p className="text-sm text-muted-foreground">
                                        Spring Batch
                    ...
                    >
                        <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            <div className="flex flex-row flex-wrap justify-center gap-4">
                                ...
                                viewBox="0,0,400,400"
                                 className="hover:animate-spin"
                                 style={{ opacity: 1, fill: "#4a5bef" }}
                                >
                                <g><path fill="#4a5bef" d="M -0.5,-0.5 C 132.833,-0.5 266.167,-0.5 399.5,-0.5C 399.5,132.833 399.5,266.167 399.5,399.5C 266.167,399.5 132.833,399.5 -0.5,399.5C -0.5,266.167 -0.5,132.833 -0.5,-0.5 Z"/></g>
                                <g><path fill="#fefefe" d="M 189.5,87.5 C 229.944,85.7981 255.11,104.465 265,143.5C 266.417,156.33 264.584,168.663 259.5,180.5C 295.704,191.905 312.871,216.572 311,254.5C 304.94,285.56 286.44,304.394 255.5,311C 217.833,311.667 180.167,311.667 142.5,311C 112.549,304.049 94.3826,285.549 88,255.5C 85.8275,217.168 102.994,192.168 139.5,180.5C 127.417,148.596 134.417,121.763 160.5,100C 169.457,93.9663 179.124,89.7997 189.5,87.5 Z"/></g>
                                <g><path fill="#4c5cef" d="M 194.5,159.5 C 198.605,159.234 202.605,159.734 206.5,161C 214.5,165.333 222.5,169.667 230.5,174C 233.835,176.679 234.335,179.845 232,183.5C 221.619,190.608 210.452,195.942 198.5,199.5C 197.167,199.333 195.833,199.167 194.5,199C 185.833,194.333 177.167,189.667 168.5,185C 164.5,181.333 164.5,177.667 168.5,174C 177.333,169.303 186,164.47 194.5,159.5 Z"/></g>
                                </svg>
                                    <p className="text-sm text-muted-foreground">
                                        Codux
                                    </p>
      ...
      <div className="flex items-center justify-center text-center  text-xl  my-4">
  © Designed & Built by Ujjwal Dhariwal · 2024
</div>
