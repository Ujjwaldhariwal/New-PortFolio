...
export const MacbookScroll = ({
  ...
  return (
    <div
  ref={ref}
  className="min-h-[200vh] flex flex-col items-center pt-0 md:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
> 
      <motion.h2
        style={{
      ...
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {badge && <div className="absolute bottom-4 left-4">{ }</div>}
      </div>
    </div>
  );
};
